const products = [
    {
        ...
        image: "https://via.placeholder.com/250/28a745/ffffff?text=Book",
    ...
    },
    {
        ...
        image: "https://via.placeholder.com/250/17a2b8/ffffff?text=Notes",
        seller: "David K. (Junior)",
        description: "Comprehensive physics study notes covering all topics for PHY101. Handwritten with diagrams and formulas. Perfect for exam preparation."
    },
    {
        id: 3,
        ...
        conditionClass: "bg-success",
        image: "https://via.placeholder.com/250/6f42c1/ffffff?text=Book",
        seller: "Sarah M. (Senior)",
        description: "Calculus I textbook, 10th edition. Hardcover. Minimal wear. Includes access code for online resources. Required for MATH101."
    },
    {
        id: 4,
        ...
        image: "https://via.placeholder.com/250/e83e8c/ffffff?text=Book",
        seller: "Mike T. (Grad Student)",
        description: "Comprehensive biology reference book. Great for BIO101 and BIO102. Some highlighting and notes in margins. Still very usable."
    },
    {
        id: 5,
        ...
        image: "https://via.placeholder.com/250/dc3545/ffffff?text=Book",
        seller: "Emily R. (Freshman)",
        description: "History of science textbook covering ancient to modern science. Paperback. Spine is cracked but pages are intact. Good for HIST101."
    },
    {
        id: 6,
        ...
        condition: "Used - Like New",
        conditionClass: "bg-success",
        image: "https://via.placeholder.com/250/ffc107/ffffff?text=Book",
        seller: "Chris L. (Sophomore)",
        description: "Introduction to programming with Python. Paperback. Minimal wear. Includes examples and exercises. Perfect for CPSC101."
    },
    {
        id: 7,
        ...
        description: "English literature anthology featuring classic and contemporary works. Hardcover. New condition. Required for ENGL101."
    },
    {
        id: 8,
        ...
        description: "Chemistry lab manual for CHM101L. Paperback. Contains completed lab reports and notes. Great for reference."
    }
];
